               ...
               <div class="layout_wrapper">
                  ...
                  <div class="layout_content">
                     <div class="feed">
                        ...
                        <c:forEach var="member" items="${RECOMEND}">
                           <div class="feed_item">
                              <div class="joke">
                                 <div class="joke_wrapper">
                                    ...
                                    <c:if test="${not member.is_followed}">
                                       <button class="follow-member" member-id="${member.id}" type="submit" tabindex="0" style="margin-top:13px;">
                                       <span tabindex="-1">Follow</span>
                                       </button>
                                    </c:if>
                                    <c:if test="${member.is_followed}">
                                       <button class="follow-member followed-button" member-id="${member.id}" type="submit" tabindex="0" style="margin-top:13px;">
                  ...
                  $.ajax({
                             ...
                             success: function(response){
                                 if(!!response){
                                    ...
                                    button.style.background="#d8e3e7";
